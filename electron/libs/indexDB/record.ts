import { ICategory } from '../../../src/api/clipboard/model';
  ...
  updateData(data: ICategory) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = function (event) {
        console.log(event);
        // 获取我们想要更新的数据
        const getData = event.target.result as ICategory;
        // // 更新你想修改的数据
        getData.categoryId = data.categoryId;
